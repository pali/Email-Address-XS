...
# This allows declaration	use Email::Address::XS ':all';
...
require XSLoader;
XSLoader::load('Email::Address::XS', $VERSION);
...
Email::Address::XS - Perl extension for blah blah blah
